package groupix05.dtproject_vibrant.cancellers;
...
public class PVJFeatureCanceller<T extends IFeatureConfig> extends FeatureCanceller {

    private final Class<T> featureConfigClass;

    public PVJFeatureCanceller(ResourceLocation registryName, Class<T> featureConfigClass) {
        super(registryName);
